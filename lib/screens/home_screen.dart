...
import 'package:islamicapp/content_screens/azkar_noom.dart';
                      ...
                      Expanded(
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            Expanded(child: Text("اذكار الاستيقاظ",style: TextStyle(color: Colors.white,fontSize: 15,fontWeight: FontWeight.w700),)),
                          ],
                        ),
                          style: ElevatedButton.styleFrom(
                            minimumSize: Size(180, 100),
